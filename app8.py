...
def main():
    ...
    # ユーザー入力
    area_query = st.selectbox('行きたい都道府県を選択してください', prefectures)
    travel_purpose = st.selectbox('旅の目的を選択してください', travel_purposes)
    starting_address = st.text_input("出発地点の住所を入力してください")
    ...
    if chosen_sites:
        ...
        previous_location = starting_address  # 出発地点から初めて計算
        ...
        if st.button('プランを生成'):
            ...
            previous_location = starting_address  # 出発地点から計画を開始
